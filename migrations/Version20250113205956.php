...
final class Version20250113205956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE todo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, project_id INTEGER NOT NULL, parent_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, due_date DATETIME DEFAULT NULL, tags CLOB DEFAULT NULL --(DC2Type:json)
        , is_done BOOLEAN DEFAULT NULL, CONSTRAINT FK_5A0EB6A0166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5A0EB6A0727ACA70 FOREIGN KEY (parent_id) REFERENCES todo (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
